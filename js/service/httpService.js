app.service('HttpService', function($resource, $alert, resourceErrorHandler, host ,resourceSuccessHandler) {
    ...
    return $resource(host.get() + '/sims-operator-api/operator/view:id', {}, {
        ...
        'getAllSubCategories':   {url : host.get() +'/ebuy-cart-service/cart/getAllSubCategories', method:'GET', interceptor : { responseError : resourceErrorHandler}},
        'saveSubCategory':   {url :  host.get() +'/ebuy-cart-service/cart/saveSubCategory', method:'POST', interceptor : { response : resourceSuccessHandler ,responseError : resourceErrorHandler}},
